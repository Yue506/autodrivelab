...
| Tingfeng Wang | ADAS / TTC Risk | `motion_prediction`, `tools/generate_adas_from_gt.py` | 在基础 TTC 风险判断上优化 `motion_prediction`，加入 EKF 目标状态平滑和 CTRV / CA 短时轨迹预测，输出 demo 级 FCW、BSD、LCA 风险事件 |
